...
def read_dataset_kde_pose_only(sim_location,room_source,time_interval): # 50x13x20
	room_measure = np.arange(1,51,1)
	dict_of_kde_pdf = {}
	for rs in room_source:
		str_room_source = '{:02d}'.format(rs)
...
def main(args):
	...
	posterior_pose_only = True
	iteration_truth = 0
	time_gas_started = 300
	...
	while not rospy.is_shutdown():
		...
		if(rospy.get_time()-start_measurement > measurement_time_sampling):
			...
			if (iteration_truth-time_gas_started > time_interval*time_variant_flag[0]):
				print "========================================"
				print "++++++++++ SHIFT TIME ++++++++++++++++++"
				print "========================================"
